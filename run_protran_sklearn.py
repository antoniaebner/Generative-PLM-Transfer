...
from src.probing.run_sklearn import RunSK
from src.params.sys import RAND_SEED, SKLEARN_ALPHAS
from src.params.emb import PROTXLSTM_INFO
from src.utils import get_filename, checkNgen_folder
...
parser.add_argument(
    ...
    metavar="EP",
    default=None,
    help="path to presaved embedding used for test set. If None is passed, will use the same folder as passed in ```embed_folder```(default: None)",
)
...
parser.add_argument(
    ...
    metavar="P",
    default=None,
    help="full path to the test dataset, in pkl or panda readable format, \
    ie: data/proeng/gb1/two_vs_rest.pkl or data/annotation/scl/balanced.csv",
)

...
#   - extended for remote homolgy task
...
from src.params.sys import DEFAULT_SPLIT
...
METRIC_DICT = {
    ...
    "evolution": [
        "train_cross-entropy",
        "val_cross-entropy",
        "test-family-holdout_cross-entropy",
        "test-family-holdout_acc",
        "test-family-holdout_top5-acc",
        "test-superfamily-holdout_cross-entropy",
        "test-superfamily-holdout_acc",
        "test-superfamily-holdout_top5-acc",
        "test-fold-holdout_cross-entropy",
        "test-fold-holdout_acc",
        "test-fold-holdout_top5-acc",
    ],
    "structure": [
        "train_cross-entropy",
        "val_cross-entropy",
...
RH_TESTS = ["test-family-holdout", "test-superfamily-holdout", "test-fold-holdout"]

# default ablation list
DEFAULT_AB_LIST = ["emb", "rand", "stat", "onehot"]

# default rand stat init dict
INIT_DICT = {"rand": "random init", "stat": "stat transfer"}
...
def metric_simplifier(metric_label: str) -> str:
    ...
    elif metric in ["ndcg", "rocauc", "top5-acc"]:

...
import numpy as np
import torch
from src.models.mamba.utils_generation  import (
    InferenceParams,
    GenerationMixin,
...
from src.models.protxlstm.utils import AA_TO_ID, decode_sequence
...
def decode_safe(
    ...
    while not should_stop(sequences[-1], inference_params):
        ...
        from src.models.protxlstm.xlstm_head import xLSTMLMHeadModel

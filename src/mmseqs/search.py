# Original code from ColabFold under MIT License.
...
from utils import get_queries, msa_to_str, safe_filename
...
def main():
    ...
    print(
        f"Total execution time: {total_time}s / {round(total_time/60,2)}min / {round(total_time/60/60,2)}h"
    )
